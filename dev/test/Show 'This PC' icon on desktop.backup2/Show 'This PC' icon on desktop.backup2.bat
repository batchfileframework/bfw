...
set TestOutputArray
REM Call :EchoArray TestOutputArray
echo.
...
Call :DereferenceArrayToArray TestElementArray TestReferenceArray TestOutputArray
set TestOutputArray
REM echo Reference to TestElementArray with explicit no suffixes
REM echo EchoArray with no suffix
REM set "EchoArraySuffix="
REM Call :EchoArray TestOutputArray
REM echo EchoArray with .suffixA , should have no output
REM set "EchoArraySuffix=.suffixA"
REM Call :EchoArray TestOutputArray
echo.
...
Call :DereferenceArrayToArray TestElementArray TestReferenceArray TestOutputArray
set TestOutputArray
REM echo Reference to TestElementArray with only .suffixA
REM set "EchoArraySuffix="
REM echo EchoArray with no suffix, should have no output
REM Call :EchoArray TestOutputArray
REM echo EchoArray for .suffixA
REM set "EchoArraySuffix=.suffixA"
REM Call :EchoArray TestOutputArray
echo.
...
Call :ClearVariablesByPrefix _DerefArray
Call :ClearVariablesByPrefix TestOutputArray
set "_DerefArrayReferenceSuffix=.suffixC\NOSUFFIX"
...
REM MAKE DECONCATENATE WORK WITH SPACES !!!!!!!!
...
REM TEST ! Multi-character delimiters ?

...
REM :ReadFileLineByLine :EchoFile
REM :InsertTextToFile filename searchtext newtext writebefore/writeafter/writeevery/writeonce
REM :FileDiff FileA FileB LinesInBoth LinesOnlyInA LinesOnlyInB
REM REM output to array or to file
REM REM :ArrayToFile
REM :FileToArray
...
REM :FindAllLabelsInAFunction
REM :FindAllLabelsInAFunctionThatDon'tExistInTheFile
REM :FindAllLabelsInAFunctionThatExistInTheFile
REM :ListFunctions Read a batch file, return all labels or return a list of all functions or return a list of all or return a named function by its label
REM :AddTemplateToFunction, when outputting a function from a batch works, output function plus full template including hashed signature
REM :ReadLookupFunctionFromBatch read a named function outputs all named lookup inputs
REM :ReadBatch Read a function to array, or to file
REM :WriteBatch Write a function to end of file
REM :ReadBatch Extract Lookup Values to array and to file

REM :GetPowerCFG
REM :SetPowerCFG

REM :SimpleSelectorMenu ListOfChoices SelectedChoice optional Question Text optional TitleText optional FooterText optinal cornertime

REM :DeleteElementsFromArray "list of array element indexes"
REM :AddElementsFromArray  input array "list of element indexes" outputarray "list of element indexes"

REM REM UI
REM :UI 
REM :long scrollable list
REM :long scrollable list of selectable items
REM :a message box with ok cancel retry
REM :a textbox with ok cancel buttons
REM :a multiple choice radio button
REM : a frame with title and footing
REM :a two pane view
REM :a two pane view, list on left, extra option per item on right, bios style
REM :MessageBox
REM :MessageBoxInputText
REM :MessageBoxYesNo
REM :MultipleChoiceSelect
REM :GetConsoleDimensions
REM :GetCursorPosition
REM :SetCursorPosition
REM :WriteTextAtCursor
